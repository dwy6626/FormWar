Public Class Results
    ...
    Private Sub Form6_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
    ...
    Private Sub Label2_MouseDoubleClick(ByVal sender As Object, ByVal e As MouseEventArgs) Handles Label2.MouseDoubleClick
        BackGround.Close()
        Main.Show()
        Me.Close()
    End Sub
